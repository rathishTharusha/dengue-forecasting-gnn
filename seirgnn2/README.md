...
| **SEIR physics as the rescue of failing encoders** (`head="gated"` = `foi_res` without the simulator) | anchor + gate carry 96–112% of the repair of STGAT/A3TGCN/DCRNN; SEIR vs its twin +0.67 (STGAT, p_adj 0.047), −0.00, −0.68 (3/9); costs 0.74–0.88 on working encoders | `rescue.json`, EXP-048. The plain residual head alone repairs them (17.47–17.84) |
