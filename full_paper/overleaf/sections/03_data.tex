...
persistence test RMSE on the frozen three origins (averaged over origins, as for
every model) moves from 44.80 (29.52 with the week-395 windows excluded) on the
array to \textbf{36.02}, and it reproduces exactly when recomputed from the raw
series. The last test
