...
\title{What Caps Dengue Forecasting?\\Reproduction, Evaluation Artifacts,
and the Limits of Mechanistic Priors}
...
% Table floats can only move FORWARD. Declared after the last section it landed
% on the references page; declared here it settles inside the body.
